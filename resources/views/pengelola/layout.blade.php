        ...
        <div class="p-6 flex flex-col h-full">
            ...
            <h2 class="text-xl font-bold text-gray-800 mb-6">Dashboard</h2>
                <ul class="space-y-4">
                    ...
                    <li>
                        <a href="/pengelola/pesanan" id="menu-pesanan" class="flex items-center px-4 py-3 text-gray-700 hover:bg-gray-50 rounded-lg transition-colors menu-item">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" />
                            </svg>
                            Pesanan
                    ...
                    <li>
                        <a href="{{ route('pengelola.poin') }}" id="menu-poin" data-route="pengelola.poin" class="flex items-center px-4 py-3 text-gray-700 hover:bg-gray-50 rounded-lg transition-colors menu-item">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
