...
@section('title', 'Kelola Produk - EcoZense')
...
<div class="mb-8">
    <div class="flex flex-col md:flex-row md:items-center md:justify-between">
        <div>
            <h1 class="text-3xl font-bold text-gray-900 mb-2">Kelola Produk</h1>
            <p class="text-gray-600">Kelola inventaris produk ramah lingkungan Anda</p>
        </div>
...
<div class="bg-white rounded-2xl shadow-xl p-8 mb-8 border border-gray-100">
    ...
    <div class="flex items-center justify-between mb-6">
        <h2 class="text-2xl font-bold text-gray-900">Produk Anda</h2>
            ...
            <div class="group bg-white rounded-xl shadow-md hover:shadow-xl border border-gray-100 overflow-hidden transition-all duration-300 hover:scale-105">
                ...
                <div class="relative h-48 overflow-hidden">
                    ...
                    <div class="absolute top-3 right-3">
                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $item->status_ketersediaan == 'Available' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
                            {{ $item->status_ketersediaan == 'Available' ? 'Tersedia' : 'Tidak Tersedia' }}
                        </span>
                    </div>
                ...
                <div class="p-5">
                    ...
                    <div class="flex space-x-2">
                        <button class="flex-1 inline-flex items-center justify-center px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-lg hover:bg-blue-700 transition-all duration-200 transform hover:scale-105" data-product='@json($item)' onclick="handleEditProductClick(this)">
                        ...
                        <form action="{{ route('products.destroy', ['product' => $item->produk_id]) }}" 
                            ...
                            <button type="submit" 
                                ...
                                <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-7-7 7-7"/></svg>
                                Delete
                            </button>
                        </form>
                    </div>
    ...
    <form action="{{ route('pengelola.toko.update') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div class="lg:col-span-2">
                <label class="block text-sm font-semibold text-gray-700 mb-3">Foto Toko</label>
                <div class="flex items-center space-x-6">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500 mt-2">PNG, JPG, JPEG maksimal 10MB</p>
                    </div>
                </div>
                @error('foto_toko')
            ...
            <!-- Operating Hours -->
            <div>
                <label class="block text-sm font-semibold text-gray-700 mb-2">Jam Operasional <span class="text-red-500">*</span></label>
                <div class="relative">
            ...
            <!-- Store Description -->
            <div class="lg:col-span-2">
                <label class="block text-sm font-semibold text-gray-700 mb-2">Deskripsi Toko <span class="text-red-500">*</span></label>
                <textarea name="deskripsi_toko" rows="4" 
                          ...
                          placeholder="Ceritakan tentang toko Anda...">{{ $user->deskripsi_toko }}</textarea>
            </div>
        </div>
...
<div id="productModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm hidden">
    <div class="bg-white rounded-2xl shadow-2xl max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
        ...
        <div class="sticky top-0 bg-white border-b border-gray-200 px-6 py-4 rounded-t-2xl">
            <div class="flex items-center justify-between">
                <h2 id="modalTitle" class="text-2xl font-bold text-gray-900">Tambah Produk</h2>
            ...
            @if($errors->any())
                <div class="mb-6 p-4 bg-red-50 border border-red-200 rounded-xl">
                    <div class="flex">
                        ...
                        <div>
                            <h3 class="text-sm font-medium text-red-800">Silakan perbaiki kesalahan berikut:</h3>
            ...
            <form id="productForm" method="POST" action="{{ route('products.store') }}" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        <label for="images" class="block text-sm font-semibold text-gray-700 mb-2">Gambar Produk *</label>
                        <div class="border-2 border-dashed border-gray-300 rounded-xl p-6 text-center hover:border-green-500 transition-colors relative">
                            ...
                            <div id="uploadPlaceholder">
                                ...
                                <p class="mt-2 text-sm text-gray-600">Klik untuk upload atau seret dan lepas</p>
                    ...
                    <!-- Product Point Price -->
                    <div>
                        <label for="harga_points" class="block text-sm font-semibold text-gray-700 mb-2">Harga Poin *</label>
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                            ...
                            <input type="number" name="harga_points" id="harga_points" required min="0"
                                   class="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-transparent transition-colors">
                        </div>
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="deskripsi" id="deskripsi" rows="4" required
                                  class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-transparent transition-colors resize-none"
                                  placeholder="Jelaskan produk Anda..."></textarea>
                    </div>
                </div>
...
<div id="modalTokoAlert" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-40 z-50 hidden">
    <div class="bg-white rounded-lg shadow-lg p-8 max-w-sm w-full text-center">
        ...
        <p class="mb-6 text-gray-700">Kolom <span class="font-semibold">Nama Bank</span> dan <span class="font-semibold">Nomor Rekening</span> wajib diisi. Silakan lengkapi sebelum menyimpan!</p>
...
function openProductModal(product = null) {
    ...
    if (product) {
        ...
        form.action = window.location.origin + '/pengelola/products';
