                            ...
                            <div class="flex items-start justify-between">
                                ...
                                <div class="flex-shrink-0 flex items-center space-x-2 ml-4">
                                    ...
                                    >
                                        ...
                                        <span id="like-count-{{ $product->produk_id }}" class="text-sm font-medium ml-2 like-count-number {{ auth()->check() && $product->likedByCurrentUser() ? 'text-red-400' : 'text-gray-400' }}">{{ $product->suka ?? 0 }}</span>
                                    </button>
                                </div>
                            </div>
