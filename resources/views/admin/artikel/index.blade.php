            ...
            <table class="min-w-full">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <div class="flex space-x-2">
                                <a href="{{ route('admin.events.edit', $event) }}" class="bg-yellow-100 hover:bg-yellow-200 text-yellow-700 px-3 py-1 rounded transition-colors">Edit</a>
    ...
    <div id="modalHapusArtikel" class="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-40 hidden">
        <div class="bg-white rounded-lg p-6 max-w-sm w-full mx-4">
            ...
            <div class="flex justify-end space-x-4">
                <button onclick="closeModal('modalHapusArtikel')" class="px-4 py-2 text-gray-600 hover:text-gray-800 transition-colors">
                    Batal
                </button>
                <form id="formHapusArtikel" method="POST" class="inline">
                    @csrf
                    @method('DELETE')
