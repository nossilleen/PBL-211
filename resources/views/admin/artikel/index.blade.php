...
@section('content')
    ...
    <div class="bg-white rounded-lg shadow-sm p-6 mb-8">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
            ...
            <button class="mt-4 md:mt-0 bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-lg transition-colors flex items-center">
            ...
            <table class="min-w-full">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Anindita A'isyahira</td>
            ...
            <table class="min-w-full">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <img src="{{ asset('images/event-banner.jpg') }}" alt="Event Banner" class="h-10 w-16 object-cover rounded">
                        </td>
                        <td class="px-6 py-4">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <a href="#" class="text-blue-600 hover:text-blue-900 text-sm">docs.google.com/form</a>
                        </td>
