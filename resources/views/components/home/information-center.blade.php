                    ...
                    <a href="/events" class="block h-full">
                        <div class="relative h-56 md:h-64 overflow-hidden">
                            ...
                            <div class="absolute bottom-6 left-6 right-6 flex items-end justify-between">
                                <div class="w-56 h-56 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center border border-white/30 group-hover:scale-110 transition-transform duration-300 mx-auto">
                                    <svg class="w-44 h-44 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
