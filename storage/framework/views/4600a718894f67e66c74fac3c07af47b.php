...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'pulse::components.select','data' => ['wire:model.live' => 'orderBy','id' => 'select-slow-outgoing-requests-order-by','label' => 'Sort by','options' => [
                    'slowest' => 'slowest',
                    'count' => 'count',
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model.live' => 'orderBy','id' => 'select-slow-outgoing-requests-order-by','label' => 'Sort by','options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([
                    'slowest' => 'slowest',
                    'count' => 'count',
                ]),'@change' => 'loading = true']); ?>
<?php echo $__env->renderComponent(); ?>
...
<?php $component->withAttributes(['expand' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($expand),'wire:poll.5s' => '']); ?>
        <!--[if BLOCK]><![endif]--><?php if($slowOutgoingRequests->isEmpty()): ?>
...
<?php endif; ?>
                <tbody>
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $slowOutgoingRequests->take(100); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $request): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php $component->withAttributes(['class' => 'max-w-[1px]']); ?>
                                <div class="flex items-center" title="<?php echo e($request->uri); ?>">
                                    <!--[if BLOCK]><![endif]--><?php if($host = parse_url($request->uri, PHP_URL_HOST)): ?>
...
<?php $component->withAttributes(['numeric' => true,'class' => 'text-gray-700 dark:text-gray-300']); ?>
                                <!--[if BLOCK]><![endif]--><?php if($request->slowest === null): ?>
...
<?php endif; ?>
            ...
            <!--[if BLOCK]><![endif]--><?php if($slowOutgoingRequests->count() > 100): ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\PBL-211\vendor\laravel\pulse\src/../resources/views/livewire/slow-outgoing-requests.blade.php ENDPATH**/ ?>