<?php use \Laravel\Pulse\Facades\Pulse; ?>
<?php $attributes ??= new \Illuminate\View\ComponentAttributeBag;

$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['cols' => 12, 'fullWidth' => false]));
...
foreach (array_filter((['cols' => 12, 'fullWidth' => false]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    ...
    <body class="bg-gray-50 dark:bg-gray-950 font-sans antialiased">
        <div class="min-h-screen">
            <header class="px-5">
                <div class="<?php echo e($fullWidth ? '' : 'container'); ?> py-3 sm:py-5 mx-auto border-b border-gray-200 dark:border-gray-900">
...
[$__name, $__params] = $__split('pulse.period-selector', []);

$__html = app('livewire')->mount($__name, $__params, 'lw-3795816144-0', $__slots ?? [], get_defined_vars());
...
?>
                            <?php if (isset($component)) { $__componentOriginalf31d4e58f6a6ae6c4c3c0c99af5e9947 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf31d4e58f6a6ae6c4c3c0c99af5e9947 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'pulse::components.theme-switcher','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('pulse::theme-switcher'); ?>
...
<?php endif; ?>
<?php if (isset($__attributesOriginalf31d4e58f6a6ae6c4c3c0c99af5e9947)): ?>
<?php $attributes = $__attributesOriginalf31d4e58f6a6ae6c4c3c0c99af5e9947; ?>
<?php unset($__attributesOriginalf31d4e58f6a6ae6c4c3c0c99af5e9947); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalf31d4e58f6a6ae6c4c3c0c99af5e9947)): ?>
<?php $component = $__componentOriginalf31d4e58f6a6ae6c4c3c0c99af5e9947; ?>
<?php unset($__componentOriginalf31d4e58f6a6ae6c4c3c0c99af5e9947); ?>
<?php endif; ?>
                        </div>
                    </div>
                </div>
            ...
            <main class="pt-6 px-6 pb-12">
                <div <?php echo e($attributes->merge(['class' => "mx-auto grid default:grid-cols-{$cols} default:gap-6" . ($fullWidth ? '' : ' container')])); ?>>
                    <?php echo e($slot); ?>
...
<?php /**PATH C:\xampp\htdocs\PBL-211\vendor\laravel\pulse\src/../resources/views/components/pulse.blade.php ENDPATH**/ ?>