...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <?php echo app('Illuminate\Foundation\Vite')(['resources/css/app.css', 'resources/js/app.js']); ?> <?php else: ?>
        <style>
        ...
        >
            <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
                    ...
                    <ul class="flex flex-col mb-4 lg:mb-6">
                        ...
                        >
                            <span class="relative py-1 bg-white dark:bg-[#161615]">
                                ...
                                >
                                    <span
                                        class="rounded-full bg-[#dbdbd7] dark:bg-[#3E3E3A] w-1.5 h-1.5"
                                    ></span>
                                </span>
                            </span>
                            <span>
                ...
                >
                    ...
                    <svg
                        class="w-[448px] max-w-none relative -mt-[4.9rem] -ml-8 lg:ml-0 lg:-mt-[6.6rem] hidden dark:block"
                        viewBox="0 0 440 376"
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
                    >
