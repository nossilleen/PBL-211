...
>
    <div class="container mx-auto px-4 bg-transparent py-10 rounded-lg">
        ...
        <p
            class="text-white text-center max-w-4xl mx-auto mb-12"
            data-aos="fade-up"
            data-aos-delay="100"
        >
        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="text-center" data-aos="fade-up" data-aos-delay="400">
                <button
                    class="bg-black text-white px-8 py-2 rounded hover:bg-gray-900 transition button-hover-effect"
                >
                    READ MORE
                </button>
            </div>
...
<?php /**PATH D:\xampp\htdocs\laravel\PBL-211\resources\views/components/home/about-us.blade.php ENDPATH**/ ?>