    ...
    <div class="container mx-auto px-4 md:px-6 flex justify-between items-center">
        ...
        <a href="/" class="flex items-center flex-shrink-0" data-aos="fade-right" data-aos-delay="100">
            <div class="bg-transparent rounded-md">
                <img src="<?php echo e(asset('images/logo.png')); ?>" alt="EcoZense Logo" class="h-5 md:h-7 w-auto">
            </div>
        </a>
...
<?php /**PATH C:\xampp\htdocs\PBL-211\resources\views/components/home/navbar.blade.php ENDPATH**/ ?>