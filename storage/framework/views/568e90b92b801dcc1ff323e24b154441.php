...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'Slow Jobs','x-bind:title' => '`Time: '.e(number_format($time, 0)).'ms; Run at: ${formatDate(\''.e($runAt).'\')};`','details' => ''.e(is_array($config['threshold']) ? '' : $config['threshold'].'ms threshold, ').'past '.e($this->periodForHumans()).'']); ?>
         <?php $__env->slot('icon', null, []); ?> 
            <?php if (isset($component)) { $__componentOriginalf35e24f78f42160862c72b7d4e8517ed = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf35e24f78f42160862c72b7d4e8517ed = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'pulse::components.icons.command-line','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('pulse::icons.command-line'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
...
<?php endif; ?>
<?php if (isset($__attributesOriginalf35e24f78f42160862c72b7d4e8517ed)): ?>
<?php $attributes = $__attributesOriginalf35e24f78f42160862c72b7d4e8517ed; ?>
<?php unset($__attributesOriginalf35e24f78f42160862c72b7d4e8517ed); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalf35e24f78f42160862c72b7d4e8517ed)): ?>
<?php $component = $__componentOriginalf35e24f78f42160862c72b7d4e8517ed; ?>
<?php unset($__componentOriginalf35e24f78f42160862c72b7d4e8517ed); ?>
<?php endif; ?>
         <?php $__env->endSlot(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'pulse::components.select','data' => ['wire:model.live' => 'orderBy','id' => 'select-slow-jobs-order-by','label' => 'Sort by','options' => [
                    'slowest' => 'slowest',
                    'count' => 'count',
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model.live' => 'orderBy','id' => 'select-slow-jobs-order-by','label' => 'Sort by','options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([
                    'slowest' => 'slowest',
                    'count' => 'count',
                ]),'@change' => 'loading = true']); ?>
<?php echo $__env->renderComponent(); ?>
...
<?php $component->withAttributes(['expand' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($expand),'wire:poll.5s' => '']); ?>
        <!--[if BLOCK]><![endif]--><?php if($slowJobs->isEmpty()): ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes([]); ?>Job <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                <tbody>
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $slowJobs->take(100); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $job): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr wire:key="<?php echo e($job->job); ?>-spacer" class="h-2 first:h-0"></tr>
                        <tr wire:key="<?php echo e($job->job); ?>-row">
...
<?php $component->withAttributes(['class' => 'max-w-[1px]']); ?>
                                <code class="block text-xs text-gray-900 dark:text-gray-100 truncate" title="<?php echo e($job->job); ?>">
                                    <?php echo e($job->job); ?>

                                </code>
                                <!--[if BLOCK]><![endif]--><?php if(is_array($config['threshold'])): ?>
                                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                                        <?php echo e($job->threshold); ?>ms threshold
                                    </p>
...
<?php $component->withAttributes(['numeric' => true,'class' => 'text-gray-700 dark:text-gray-300 font-bold']); ?>
                                <!--[if BLOCK]><![endif]--><?php if($config['sample_rate'] < 1): ?>
                                    <span title="Sample rate: <?php echo e($config['sample_rate']); ?>, Raw value: <?php echo e(number_format($job->count)); ?>">~<?php echo e(number_format($job->count * (1 / $config['sample_rate']))); ?></span>
                                <?php else: ?>
                                    <?php echo e(number_format($job->count)); ?>
...
<?php $component->withAttributes(['numeric' => true,'class' => 'text-gray-700 dark:text-gray-300']); ?>
                                <!--[if BLOCK]><![endif]--><?php if($job->slowest === null): ?>
                                    <strong>Unknown</strong>
                                <?php else: ?>
                                    <strong><?php echo e(number_format($job->slowest) ?: '<1'); ?></strong> ms
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal0f7c58665987afe4db27bde6fd86e915)): ?>
...
<?php endif; ?>
        ...
        <!--[if BLOCK]><![endif]--><?php if($slowJobs->count() > 100): ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\PBL-211\vendor\laravel\pulse\src/../resources/views/livewire/slow-jobs.blade.php ENDPATH**/ ?>